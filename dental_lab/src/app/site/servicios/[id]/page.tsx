                ...
                <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
                    <div className="relative isolate overflow-hidden bg-slate-300 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                        ...
                        <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                            <h2 className="text-3xl font-bold tracking-tight text-gray-950 sm:text-4xl">Libres de metal</h2>
                                <p className="mt-6 text-lg leading-8 text-gray-800"></p>
                                <ul className='list-disc'>
                                    <li>Coronas y puentes de porcelana</li>
                                    <li>Carillas de porcelana</li>
                                    <li>Prótesis dentales flexibles</li>
                                    <li>Implantes dentales de cerámica</li>
                                    <li>Puentes y coronas de zirconia</li>
                                </ul>
